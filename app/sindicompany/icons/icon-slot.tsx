...
import { getIconUploadIntent } from "../revista/nova/upload-actions";
...
export function IconSlot({ slot, initialUrl }: IconSlotProps) {
  ...
  async function handleFile(file: File) {
    ...
    const intent = await getIconUploadIntent(slot, ext);
    if (!intent.ok) {
      setStatus("error");
