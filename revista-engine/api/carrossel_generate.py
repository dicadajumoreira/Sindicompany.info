...
def _gerar_copy(carrossel: dict[str, Any]) -> dict[str, Any]:
    ...
    prompt = (
        ...
        + f"\n"
        f"CONTEXTO OBRIGATORIO:\n"
        f"- O carrossel sempre fala de CONDOMINIO e VIVENCIA DE "
        f"CONDOMINIO. Cada copy precisa ancorar o tema dentro do "
        f"dia a dia do condominio: assembleia, taxa, sindico, "
        f"morador, area comum, regulamento, convivencia, fachada, "
        f"manutencao, etc. Pelo menos UM dos slides deve mencionar "
        f"literalmente 'condominio' ou 'condominial'.\n\n"
        f"REGRAS:\n"
        ...
        f"título, sempre ancorado no contexto condominial. Body opcional. "
        f"A capa inteira (titulo + body) tem no maximo 20 palavras.\n"
